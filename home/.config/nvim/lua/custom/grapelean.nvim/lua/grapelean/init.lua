...
Color.new('green_bg_emphasis', M.adjust_transparency(palette.green, palette.bg, 0.2))
Color.new('red_bg', M.adjust_transparency(palette.red, palette.bg, 0.1))
Color.new('red_bg_emphasis', M.adjust_transparency(palette.red, palette.bg, 0.2))
